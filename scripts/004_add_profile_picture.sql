-- Add profile picture column to doctors table
ALTER TABLE doctors 
...
CREATE TRIGGER update_xray_files_updated_at BEFORE UPDATE ON xray_files FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
